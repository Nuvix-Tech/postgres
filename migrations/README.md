...
2. Run all `db/migrations` with `nuvix_admin` superuser role.
...
Note: Migrations are applied using the `nuvix_admin` superuser role, as specified in the "How it was Created" section above.
