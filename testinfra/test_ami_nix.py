...
GOTRUE_DB_DATABASE_URL=postgres://nuvix_admin@localhost/postgres?sslmode=disable
GOTRUE_JWT_ADMIN_ROLES=nuvix_admin,service_role
...
nuvix_admin_key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFhYWFhYWFhYWFhYWFhYWFhYWFhIiwicm9sZSI6InN1cGFiYXNlX2FkbWluIiwiaWF0IjoxNjk2MjI0OTY2LCJleHAiOjIwMTE4MDA5NjZ9.jrD3j2rBWiIx0vhVZzd1CXFv7qkAP392nBMadvXxk1c"
init_json_content = f"""
{{
  "jwt_secret": "my_jwt_secret_which_is_not_so_secret",
  ...
  "nuvix_admin_key": "{nuvix_admin_key}",
...
""",
    ...
    def is_healthy(ssh) -> bool:
        health_checks = [
            ...
            ("adminapi", f"curl -sf -k --connect-timeout 30 --max-time 60 https://localhost:8085/health -H 'apikey: {nuvix_admin_key}'"),
